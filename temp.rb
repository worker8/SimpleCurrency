...
client.add_comment(repo_name, PR_NUMBER, "LSJDLKASJDSJD body_string")




# 1. pass secret personal token into ruby file
# 2. pass PR id into args
# 3. client.add_comment("worker8/SimpleCurrency", 2, table_markdown)
#
#
